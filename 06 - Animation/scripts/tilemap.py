...
class Tilemap:
    ...
    def __init__(self, jogo, tam_tile=16):
        ...
        self.tilemap = {}  # armazenar as informações dos tiles
    ...
    def renderizar(self, superficie, deslocamento=(0, 0)) -> None:
        ...
        for tile in self.offgrid_tiles:
            superficie.blit(
                ...
                (tile['pos'][0] - deslocamento[0],
                 tile['pos'][1] - deslocamento[1])
            )

        # --- Renderizar os tiles --- #
        for x in range(deslocamento[0] // self.tam_tile, (deslocamento[0] + superficie.get_width()) // self.tam_tile + 1):
            for y in range(deslocamento[1] // self.tam_tile, (deslocamento[1] + superficie.get_height()) // self.tam_tile + 1):
                loc = str(x) + ';' + str(y)
                if loc in self.tilemap:
                    ...
                    superficie.blit(
                        ...
                        (
                            tile['pos'][0] * self.tam_tile - deslocamento[0],
                            tile['pos'][1] * self.tam_tile - deslocamento[1]
                        )
                    )
